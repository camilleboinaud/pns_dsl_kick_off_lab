...
public class StateImpl extends NamedElementImpl implements State {
	...
	public void setTransition(Transition newTransition) {
		if (newTransition != transition) {
			...
			if (transition != null)
				msgs = ((InternalEObject)transition).eInverseRemove(this, ArduinoMLPackage.TRANSITION__STATE, Transition.class, msgs);
			if (newTransition != null)
				msgs = ((InternalEObject)newTransition).eInverseAdd(this, ArduinoMLPackage.TRANSITION__STATE, Transition.class, msgs);
